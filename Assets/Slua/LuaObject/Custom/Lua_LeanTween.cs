...
public class Lua_LeanTween : LuaObject {
	...
	static public int add_s(IntPtr l) {
		try{
			...
			UnityEngine.Vector3[] ret=LeanTween.add(a1,a2);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int closestRot_s(IntPtr l) {
		try{
			...
			System.Single a2;
			checkType(l,2,out a2);
			System.Single ret=LeanTween.closestRot(a1,a2);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int description_s(IntPtr l) {
		try{
			System.Int32 a1;
			checkType(l,1,out a1);
			LTDescr ret=LeanTween.description(a1);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int isTweening_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject))){
				UnityEngine.GameObject a1;
				checkType(l,1,out a1);
				System.Boolean ret=LeanTween.isTweening(a1);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int logError_s(IntPtr l) {
		try{
			System.String a1;
			checkType(l,1,out a1);
			System.Object ret=LeanTween.logError(a1);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int options_s(IntPtr l) {
		try{
			...
			if(argc==1){
				LTDescr a1;
				checkType(l,1,out a1);
				LTDescr ret=LeanTween.options(a1);
				pushValue(l,ret);
				return 1;
			}
			else if(argc==0){
				LTDescr ret=LeanTween.options();
				pushValue(l,ret);
				return 1;
			}
			LuaDLL.luaL_error(l,"No matched override function to call");
	...
	static public int alpha_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float))){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.alpha(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
				...
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.alpha(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int alphaVertex_s(IntPtr l) {
		try{
			...
			System.Single a3;
			checkType(l,3,out a3);
			LTDescr ret=LeanTween.alphaVertex(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int color_s(IntPtr l) {
		try{
			...
			System.Single a3;
			checkType(l,3,out a3);
			LTDescr ret=LeanTween.color(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int delayedCall_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(float),typeof(System.Action))){
				...
				LTDescr ret=LeanTween.delayedCall(a1,a2);
				pushValue(l,ret);
				return 1;
			}
				...
				LTDescr ret=LeanTween.delayedCall(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
				...
				checkType(l,3,out a3);
				System.Int32 ret=LeanTween.delayedCall(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
				...
				System.Object[] a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.delayedCall(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int destroyAfter_s(IntPtr l) {
		try{
			...
			System.Single a2;
			checkType(l,2,out a2);
			LTDescr ret=LeanTween.destroyAfter(a1,a2);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int move_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float))){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.move(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.move(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int moveSpline_s(IntPtr l) {
		try{
			...
			System.Single a3;
			checkType(l,3,out a3);
			LTDescr ret=LeanTween.moveSpline(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int moveSplineLocal_s(IntPtr l) {
		try{
			...
			System.Single a3;
			checkType(l,3,out a3);
			LTDescr ret=LeanTween.moveSplineLocal(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int moveMargin_s(IntPtr l) {
		try{
			...
			System.Single a3;
			checkType(l,3,out a3);
			LTDescr ret=LeanTween.moveMargin(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int moveX_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.moveX(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.moveX(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int moveY_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.moveY(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.moveY(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int moveZ_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.moveZ(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.moveZ(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int moveLocal_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float))){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.moveLocal(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3[]),typeof(float))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.moveLocal(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float),typeof(object[]))){
	...
	static public int moveLocalX_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.moveLocalX(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.moveLocalX(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int moveLocalY_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.moveLocalY(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.moveLocalY(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int moveLocalZ_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.moveLocalZ(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.moveLocalZ(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int rotate_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float))){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.rotate(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(LTRect),typeof(float),typeof(float))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.rotate(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float),typeof(object[]))){
	...
	static public int rotateLocal_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.rotateLocal(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.rotateLocal(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float),typeof(object[]))){
	...
	static public int rotateX_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.rotateX(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.rotateX(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int rotateY_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.rotateY(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.rotateY(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int rotateZ_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.rotateZ(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.rotateZ(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int rotateAround_s(IntPtr l) {
		try{
			...
			if(argc==4){
				...
				System.Single a4;
				checkType(l,4,out a4);
				LTDescr ret=LeanTween.rotateAround(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
				...
				System.Int32 ret=LeanTween.rotateAround(a1,a2,a3,a4,a5);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int rotateAroundLocal_s(IntPtr l) {
		try{
			...
			System.Single a4;
			checkType(l,4,out a4);
			LTDescr ret=LeanTween.rotateAroundLocal(a1,a2,a3,a4);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int scale_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float))){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.scale(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(LTRect),typeof(UnityEngine.Vector2),typeof(float))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.scale(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float),typeof(object[]))){
	...
	static public int scaleX_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.scaleX(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.scaleX(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int scaleY_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.scaleY(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.scaleY(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int scaleZ_s(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				System.Single a3;
				checkType(l,3,out a3);
				LTDescr ret=LeanTween.scaleZ(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(System.Collections.Hashtable))){
				...
				System.Collections.Hashtable a4;
				checkType(l,4,out a4);
				System.Int32 ret=LeanTween.scaleZ(a1,a2,a3,a4);
				pushValue(l,ret);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(float),typeof(float),typeof(object[]))){
	...
	static public int value_s(IntPtr l) {
		try{
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(System.Action<System.Single>),typeof(float),typeof(float),typeof(float))){
				...
				System.Single a5;
				checkType(l,5,out a5);
				LTDescr ret=LeanTween.value(a1,a2,a3,a4,a5);
				pushValue(l,ret);
				return 1;
			}
				...
				System.Collections.Hashtable a5;
				checkType(l,5,out a5);
				System.Int32 ret=LeanTween.value(a1,a2,a3,a4,a5);
				pushValue(l,ret);
				return 1;
			}
				...
				System.Int32 ret=LeanTween.value(a1,a2,a3,a4,a5,a6);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int delayedSound_s(IntPtr l) {
		try{
			...
			System.Single a3;
			checkType(l,3,out a3);
			LTDescr ret=LeanTween.delayedSound(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int h_s(IntPtr l) {
		try{
			System.Object[] a1;
			checkType(l,1,out a1);
			System.Collections.Hashtable ret=LeanTween.h(a1);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int removeListener_s(IntPtr l) {
		try{
			...
			if(argc==2){
				...
				System.Action<LTEvent> a2;
				checkDelegate(l,2,out a2);
				System.Boolean ret=LeanTween.removeListener(a1,a2);
				pushValue(l,ret);
				return 1;
			}
			else if(argc==3){
				...
				System.Action<LTEvent> a3;
				checkDelegate(l,3,out a3);
				System.Boolean ret=LeanTween.removeListener(a1,a2,a3);
				pushValue(l,ret);
				return 1;
			}
			LuaDLL.luaL_error(l,"No matched override function to call");
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(LeanTween),typeof(UnityEngine.MonoBehaviour));
	}
}
