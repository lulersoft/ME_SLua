...
public class Lua_LTRect : LuaObject {
	...
	static public int setFontScaleToFit(IntPtr l) {
		try{
			...
			System.Boolean a1;
			checkType(l,2,out a1);
			LTRect ret=self.setFontScaleToFit(a1);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int setUseSimpleScale(IntPtr l) {
		try{
			...
			if(argc==3){
				...
				UnityEngine.Rect a2;
				checkType(l,3,out a2);
				LTRect ret=self.setUseSimpleScale(a1,a2);
				pushValue(l,ret);
				return 1;
			}
			else if(argc==2){
				...
				System.Boolean a1;
				checkType(l,2,out a1);
				LTRect ret=self.setUseSimpleScale(a1);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int setSizeByHeight(IntPtr l) {
		try{
			...
			System.Boolean a1;
			checkType(l,2,out a1);
			LTRect ret=self.setSizeByHeight(a1);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
